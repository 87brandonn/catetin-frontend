...
interface IBarangSortBottomSheet {
...
function BarangSortBottomSheet({ onResetSort, onApplySort, sortData }: IBarangSortBottomSheet) {
...
export default BarangSortBottomSheet;
